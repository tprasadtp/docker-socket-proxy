...
# Registry namespace
# For Dockerhub This is docker.io/username for GitHub registru ghcr.io/username
...
# The we do not wish to add any suffixes to image tags. Otherwise we
...
ifeq ($(GIT_REF),master)
	DOCKER_TAGS := $(foreach __REG,$(DOCKER_REGISTRY_NAMESPACES),$(__REG)/$(IMAGE_NAME):latest$(DOCKER_TAG_SUFFIX))

# Check if VERSION is defined, if so tag image with version.
ifneq ($(VERSION),)
	DOCKER_TAGS += $(foreach __REG,$(DOCKER_REGISTRY_NAMESPACES),$(__REG)/$(IMAGE_NAME):$(VERSION)$(DOCKER_TAG_SUFFIX))
endif

else
	DOCKER_TAGS := $(foreach __REG,$(DOCKER_REGISTRY_NAMESPACES),$(__REG)/$(IMAGE_NAME):$(GIT_REF)$(DOCKER_TAG_SUFFIX))
endif
